...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, 
  ExclamationCircleOutlined, StopOutlined, TrophyOutlined, CheckOutlined, NumberOutlined, ThunderboltOutlined } from '@ant-design/icons';
...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    // { title: '24h Volume', value: `$ ${cryptoDetails?.Volume && millify(cryptoDetails?.Volume24h)}`, icon: <ThunderboltOutlined /> },
